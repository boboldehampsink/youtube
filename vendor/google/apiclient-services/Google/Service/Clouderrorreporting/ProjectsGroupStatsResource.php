 ...
 *  </code>
 */
class Google_Service_Clouderrorreporting_ProjectsGroupStatsResource extends Google_Service_Resource
{
  /**
   ...
   *
   * @opt_param string alignment The alignment of the timed counts to be returned.
