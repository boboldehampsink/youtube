 ...
 *  </code>
 */
class Google_Service_Logging_ProjectsMetricsResource extends Google_Service_Resource
{
  /**
   ...
   * @return Google_Service_LogMetric
   */
   ...
   * request.
   * @return Google_Service_ListLogMetricsResponse
   */
